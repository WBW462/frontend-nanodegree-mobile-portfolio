...
function updatePositions() {
    ...
    for (var a, b = document.getElementsByClassName("mover"), c = document.body.scrollTop / 1250, d = 0; d < b.length; d++) {
        var a = Math.sin(c + d % 5);
    ...
    frame % 10 === 0) {
        var e = window.performance.getEntriesByName("measure_frame_duration");
        logAverageFrame(e);
    }
}
...
var adjectives = [ "dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific" ], nouns = [ "animals", "everyday", "fantasy", "gross", "horror", "jewelry", "places", "scifi" ], selectRandomMeat = function() {
    ...
    function d(a) {
        for (var b = document.querySelectorAll(".randomPizzaContainer").length, d = 0, e = c(document.querySelectorAll(".randomPizzaContainer")[d], a), f = document.querySelectorAll(".randomPizzaContainer")[d].offsetWidth + e + "px", d = 0; b > d; d++) document.getElementsByClassName("randomPizzaContainer")[d].style.width = f;
    }
